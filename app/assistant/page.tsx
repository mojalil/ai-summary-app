...
const AssistantPage = () => {
  ...
  return (
    ...
    {/* Assistant sidebar */}
    <div className="flex-none w-2/4 p-4 rounded-lg m-1"> {/* flex-none prevents the sidebar from growing */}
      <Assistant />
    </div>
    {/* Assistant display */}
    <div className="flex-grow p-4 overflow-auto bg-primary/5 rounded-lg m-1"> {/* flex-grow allows the display to take up the remaining space */}
      <AssistantDisplay />
    </div>
  </div>
  );
